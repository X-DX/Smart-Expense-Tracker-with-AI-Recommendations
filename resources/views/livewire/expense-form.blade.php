        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-indigo-100 mt-1">{{ $isEdit ? 'Update expense details' : 'Record a new expense' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="amount" wire:model="amount" step="0.01" min="0" placeholder="0.00"
                                class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('amount') border-red-500 @enderror">
                        </div>
                        @error('amount')
                    ...
                    <div>
                        ...
                        <input type="date" id="date" wire:model="date"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('date') border-red-500 @enderror">
                        @error('date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="title" wire:model="title" placeholder="e.g., Grocery Shopping"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('title') border-red-500 @enderror">
                        @error('title')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select wire:model="category_id" id="category_id"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea wire:model="description" id="description" rows="3"
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600"></textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="recurring_frequency" id="recurring_frequency"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('recurring_frequency') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="date" id="recurring_start_date" wire:model="recurring_start_date"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('recurring_start_date') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="date" id="recurring_end_date" wire:model="recurring_end_date"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 @error('recurring_end_date') border-red-500 @enderror">
