<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-100 mb-1">Active Recurring</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{{ $recurringExpenses->count() }}
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-100 mb-1">Monthly Total</p>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-100 mb-1">Generated This Month</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">
